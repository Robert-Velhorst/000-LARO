...
The obsolete `OnboardingWizard` prototype was also deleted after the maintained
dashboard gained its owner-scoped setup flow. The prototype used one browser
`localStorage` flag for every account and advertised shortcuts and capabilities
that were not mounted in the product.
