...
The local #193 reproduction built implementation commit `dc3884b` as
`sha256:f1c65ef844f29b7c60e2a79382c2894ccaeba65fa23bc1fdf8223f09270bd8d5`.
Trivy 0.74.0 found zero HIGH/CRITICAL Debian or Node vulnerabilities. The
591,669-byte CycloneDX SBOM has SHA-256
`4dee0fb466cd381bef5022f38dfaa505dc124b2d394e79db635fd8b8cbc01425`.
This local result does not replace the security workflow on the pushed commit.
