...
Scanned **163** runtime files (server, src-main, shared) and **264** other files (src, scripts, tests).
...
| `server/outreachSend.ts` | 259 | `* `sender` is injectable (tests pass a fake); production uses systemEmail.` |
...
## Markers in tests / scripts / renderer (246) — reported, not failing
