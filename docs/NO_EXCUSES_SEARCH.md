...
Scanned **222** runtime files (server, src-main, shared) and **339** other files (src, scripts, tests).
...
| File | Line | Marker |
|---|---|---|
| `server/_core/env.ts` | 104 | `* Insecure placeholder values that must never be used to sign real sessions.` |
