...
Scanned **213** runtime files (server, src-main, shared) and **327** other files (src, scripts, tests).
...
| `server/routers/index.ts` | 510 | `// stub): computes genuine clarifications the user must resolve BEFORE outreach` |
...
## Markers in tests / scripts / renderer (370) — reported, not failing
