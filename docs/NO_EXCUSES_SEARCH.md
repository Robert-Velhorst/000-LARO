...
Scanned **173** runtime files (server, src-main, shared) and **277** other files (src, scripts, tests).
...
## Markers in tests / scripts / renderer (315) — reported, not failing
...
| `tests/backend/oauthTokenRetry.test.ts` | 12 |
