...
Scanned **161** runtime files (server, src-main, shared) and **263** other files (src, scripts, tests).
...
| File | Line | Marker |
|---|---|---|
| `server/cronScheduler.ts` | 126 | `// Date.now via a helper so it is easy to reason about / stub if needed.` |
