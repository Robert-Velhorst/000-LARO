...
2. Complete renderer NL/EN string migration. Auto-collection settings, the
   ...
   evidence coverage, case-scoped public research, the case list, and shared
   search filters are catalog-driven and browser-tested; the blocking copy
   audit currently acknowledges 1,199 legacy candidates across 50 files.
